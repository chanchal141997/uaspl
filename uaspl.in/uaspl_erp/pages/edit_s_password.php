...
if (isset($_POST['edit'])) {
    ...
    if ($query) {
        ...
        echo '<script> alert("Society Login Details Updated successfully.....")
        window.location.href="./s_login_data.php";</script>';
    } else {
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <form class="form-horizontal" method="POST" action="#">
                                        <div class="card-body">
                                            <h4 class="card-title">Edit Society Login Details</h4>
                                        ...
                                        <div class="border-top">
                                            <div class="card-body">
                                                ...
                                                <a href="s_login_data.php" class="btn btn-danger" value="Cancel">Cancel</a>
