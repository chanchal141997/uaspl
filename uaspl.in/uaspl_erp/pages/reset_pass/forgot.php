...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($connection,"select email from admin where email='$email'");
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <a href="http://technoriya.co/Vendor_MS/VMS/pages/reset_pass/passwordreset.php?secret='.base64_encode($email).'">Reset Password</a>
     </button></p>
     <br>
